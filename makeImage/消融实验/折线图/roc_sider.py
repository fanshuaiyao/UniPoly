...
# 1) 数据集配置（写死）
# =========================
CSV_PATH    = "/root/UniPoly/moleculenet/classification/Sider.csv"
LABEL_COL   = "Hepatobiliary_disorders"
DATASET     = "Sider"
SUBFIG      = "(f)"
TARGET_AUCS = [0.638, 0.645, 0.655, 0.661, 0.669]  # w/o ALL, w/o STC, w/o TC, w/o C, KGAMA

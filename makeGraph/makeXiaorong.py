...
results = np.array([
    [0.825, 0.898, 0.795, 0.771, 0.695, 0.638], # G (纯图基础)
    ...
    [0.870, 0.930, 0.941, 0.852, 0.712, 0.673]  # G+F+S+T (Cross-Attn, 你的最终模型值)
])
...
std = np.array([
    ...
    [0.004, 0.006, 0.008, 0.005, 0.007, 0.006]
])
...
plt.savefig("ablation_study_final.pdf", format="pdf", bbox_inches="tight")
